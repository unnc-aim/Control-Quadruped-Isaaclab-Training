...
class MyTerrainSceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        prim_path="{ENV_REGEX_NS}/Robot/LynxC_URDF/Body_FOR_URDF",
...
class EventCfg:
    ...
    #     mode="startup",
    #     params={
    #         "asset_cfg": SceneEntityCfg("robot", body_names=LYNX_BASE_BODIES),
...
class RewardsCfg:
    ...
    undesired_thigh_contact = RewTerm(
        ...
        weight=-10.0,
        params={
            "sensor_cfg": SceneEntityCfg("contact_sensor", body_names=LYNX_THIGH_BODIES),
            "threshold": 1.0,
        },
    )
...
class TerminationsCfg:
    ...
    base_contact = DoneTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg("contact_sensor", body_names=LYNX_BASE_BODIES),
            "threshold": 1.0,
        },
    )
...
@configclass
class LynxTerrainEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class LynxTerrainEnvCfg_PLAY(LynxTerrainEnvCfg):
